...
import me.loving11ish.clans.api.events.ClanCreateEvent;
...
public class ClanCreateSubCommand {
    ...
    private final int MIN_CHAR_LIMIT = clansConfig.getInt("clan-tags.min-character-limit");
    private final int MAX_CHAR_LIMIT = clansConfig.getInt("clan-tags.max-character-limit");

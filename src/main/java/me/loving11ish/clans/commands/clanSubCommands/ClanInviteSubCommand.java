                        ...
                        if (invitedPlayer == null) {
                            ...
                            if (!(player.hasPermission("clanslite.maxclansize.*")||player.hasPermission("clanslite.*")||player.isOp())){
                                if (!clansConfig.getBoolean("clan-size.tiered-clan-system.enabled")){
                                    if (clan.getMembers().size() >= clansConfig.getInt("clan-size.default-max-clan-size")) {
                                    ...
                                    if (player.hasPermission("clanslite.maxclansize.group6")){
                                        if (clan.getMembers().size() >= clansConfig.getInt("clan-size.tiered-clan-system.permission-group-list.group-6")){
                                        ...
                                        if (clan.getMembers().size() >= clansConfig.getInt("clan-size.tiered-clan-system.permission-group-list.group-2")){
                                        ...
                                        if (clan.getMembers().size() >= clansConfig.getInt("clan-size.tiered-clan-system.permission-group-list.group-4")) {
                                        ...
                                        if (clan.getMembers().size() >= clansConfig.getInt("clan-size.tiered-clan-system.permission-group-list.group-1")) {
